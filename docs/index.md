...
Welcome to the **community knowledge base for PezkuwiChain** — a sovereign
blockchain ecosystem built for the Kurdish nation and the cultural nations of
the world.

This wiki explains, in plain language, how the network is put together, what its
tokens are, and how to use the apps around it. If you are a developer looking for
the SDK and runtime reference, see the **[SDK documentation](https://docs.pezkuwichain.io/)**.
...
| You want to… | Go to |
|--------------|-------|
| Understand the chains | [Architecture](architecture.md) |
...
!!! note "About this wiki"
    ...
    [SDK docs](https://docs.pezkuwichain.io/) and the on-chain state. Found a
    mistake? Edits are welcome via the ✏️ button (opens a pull request on the
    [`pezkuwichain/wiki`](https://github.com/pezkuwichain/wiki) repository).
